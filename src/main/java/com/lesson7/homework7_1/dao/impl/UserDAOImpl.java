...
import com.lesson7.homework7_1.model.User_;
...
public class UserDAOImpl extends GeneralDAOImpl<User> implements UserDAO {
    ...
    public User getUserByLoginAndPassword(String userName, String password) {
        ...
        //Login
        criteria = cb.and(criteria, cb.equal(userRoot.get(User_.userName), userName));
        criteria = cb.and(criteria, cb.equal(userRoot.get(User_.password), password));
